...
BEGIN 
    ...
    '  Please delete previous information incase of updating the same unique code. Code provided at the end.' );
...
INSERT INTO handwash VALUES('Afghanistan','AFG','People with basic handwashing facilities including soap and water rural 
(% of rural population)','Rural','SH.STA.HYGN.RU.ZS',2021,'YR2021',35,'ZZZYR2021Rural');

INSERT INTO wash_table VALUES('Afghanistan', 2021,'Total',35,32,41,19);
